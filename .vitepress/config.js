  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      { text: "JS", collapsed: true, items: [
        ...
        { text: '属性描述符', link: '/js/property-descriptor' },
        { text: 'promise', link: '/js/promise' },
        { text: '事件汇总', link: '/js/event' },
        { text: 'window', link: '/js/window-doc' },
        ...
        { text: 'web-animation', link: '/js/web-animation' },
        { text: '观察器', link: '/js/observers' },
